...
class Booth
  def self.run
    ...
    puts "Cleaning Up"
    File.delete("./pictures/#{folder_timestamp}/composite1.jpg")
    File.delete("./pictures/#{folder_timestamp}/composite2.jpg")
    File.delete("./pictures/#{folder_timestamp}/composite3.jpg")
    File.delete("./pictures/#{folder_timestamp}/animated.gif")
    File.delete("./pictures/#{folder_timestamp}/strip1.jpg")
    File.delete("./pictures/#{folder_timestamp}/strip2.jpg")
